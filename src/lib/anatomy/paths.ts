...
export const MUSCLE_PATHS: MusclePath[] = [
  ...
  // FRONT — Depth 2: heads of the quads and adductors sit on their parents
  ...bilateral("vastus_lateralis", "front", [
    [68, 262],
    [60, 270],
    [58, 312],
    [62, 350],
  ...
  ...bilateral("rectus_femoris", "front", [
    [76, 254],
    [70, 262],
    [70, 330],
    [78, 344],
  ...
  ...bilateral("vastus_medialis", "front", [
    [90, 300],
    [88, 330],
    [92, 352],
    [100, 350],
  ...
  // BACK — Depth 2
  ...bilateral("adductor_magnus", "back", [
    [100, 296],
    [98, 330],
    [100, 362],
    [110, 356],
  ...
  ...bilateral("splenius_capitis", "back", [
    [104, 72],
    [98, 78],
    [96, 92],
    [104, 96],
